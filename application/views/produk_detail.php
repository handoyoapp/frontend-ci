...
<div id="sidebar" class="span3">
    ...
    <li><a href="<?php echo base_url(); ?>home/produk">Produk</a> <span class="divider">/</span></li>
			...
			<div id="myCarousel" class="carousel slide cntr">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="#"> <img src="<?php echo $image; ?>" alt="" style="width:100%"></a>
                  </div>
                  <div class="item">
                     <a href="#"> <img src="<?php echo $image; ?>" alt="" style="width:100%"></a>
                  </div>
			...
			<div class="span7">
				...
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>Rp <?php echo number_format($harga,0,',','.');?>,-</span></label>
					<div class="controls">
